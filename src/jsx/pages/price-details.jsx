                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="price-deposit">
                                        ...
                                        <form action="#">
                                        <img src={tokenqrcode} alt="" className="contact-qrcode " />
                                            <label className="form-label">BTC Deposit Address</label>
                                            <div className="input-group">
                                                <input type="text" className="form-control"
                                                    value="35Hb5B6qJa5ntYaNFN3hGYXdAjh919g2VH" readOnly/>

                                                 <CopyButton className="input-group-text" text="35Hb5B6qJa5ntYaNFN3hGYXdAjh919g2VH" />
