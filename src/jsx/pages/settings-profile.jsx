                                                ...
                                                <form action="#">
                                                    <div className="row g-3">
                                                        ...
                                                        <div className="col-xxl-12">
                                                            <div className="d-flex align-items-center">
                                                                <img className="mr-3 rounded-circle mr-0 mr-sm-3"
                                                                    src={profile6} width="55" height="55"
                                                                    alt=""/>
                                                        ...
                                                        <div className="col-xxl-12">
                                                             <Link to={"/profile"}>
                                                                 <button to={"/profile"}
                                                                    className="btn btn-success pl-5 pr-5 waves-effect">Save
                                                                </button>
                                                             </Link>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="row g-3">
                                                        ...
                                                        <div className="col-xxl-12">
                                                            ...
                                                            <input type="password" className="form-control"
                                                                placeholder="**********"/>
                                                            <small className="mt-2 mb-0 d-block">Enable two factor authencation on the
                                                                security
                                                                page
                                                            </small>
                                                        </div>
                                                ...
                                                <form method="post" name="myform" className="personal_validate"
                                                    ...
                                                    <div className="row g-4">
                                                        ...
                                                        <div className="col-xxl-6 col-xl-6 col-lg-6">
                                                            ...
                                                            <a href="https://worldpostalcode.com/lookup" target="_blank"><small className="ml-1">find</small></a>
                                                            </label>
